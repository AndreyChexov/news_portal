<?php
    session_start();
    require '../../controllers/UserDataController/Auth/UserData.php';
    require '../../controllers/UserDataController/Auth/ValidationDataUser.php';
    ...
    $checkData->checkData($log, $pass, Connect::getInstance()->getConnect());
